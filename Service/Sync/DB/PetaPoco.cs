...
#pragma warning disable 1066,1570,1573,1591
    ...
    public class Database : IDatabase
    {
        ...
        public Database()
        {
            ...
            var entry = ConfigurationManager.ConnectionStrings[1];
        ...
        ///     the new id is returned.
        /// </remarks>
        public object InsertList(string tableName, string primaryKeyName, bool autoIncrement, dynamic pocoList)
        {
            if (string.IsNullOrEmpty(tableName))
                throw new ArgumentNullException("tableName");
            ...
            return ExecuteInsertList(tableName, primaryKeyName, autoIncrement, pocoList);
        }
        ...
        private object ExecuteInsertList(string tableName, string primaryKeyName, bool autoIncrement, dynamic pocoList)
        {
            try
            {
                OpenSharedConnection();
                try
                {
                    using (var cmd = CreateCommand(_sharedConnection, ""))
                    {
                        ...
                        foreach (var poco in pocoList)
                        {
                            ...
                            sb.AppendLine(string.Format("INSERT INTO {0} ({1}){2} VALUES ({3})",
                                _provider.EscapeTableName(tableName),
                                string.Join(",", names.ToArray()),
                                outputClause,
                                string.Join(",", values.ToArray())
